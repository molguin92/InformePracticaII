...
\begin{figure}
    ...
    \end{center}
    \label{diag:bike}
    \caption{Diagrama de estados de la bicicleta.}
\end{figure}
...
\begin{figure}
    \begin{center}
        \begin{tikzpicture}[scale=0.2, align=center]
            ...
            \draw (49.8,-4.89) node [above] {TRIGGER};
            ...
            \draw (49.93,-41.31) node [below] {TRIGGER};
    ...
    \end{center}
    \label{diag:car}
    \caption{Diagrama de estados del automóvil.}
\end{figure}
