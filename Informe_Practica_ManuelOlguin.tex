...
\begin{thebibliography}{5}
    ...
    \bibitem{eudirective}
  		\hbadness=10000 Directive 2010/40/EU of the European Parliament and of the Council
    ...
    \bibitem{omnet}
  		\hbadness=10000 OMNeT++ Discrete Event Simulator.
    ...
    \bibitem{sumo}
  		\hbadness=10000 SUMO – Simulation of Urban MObility.
